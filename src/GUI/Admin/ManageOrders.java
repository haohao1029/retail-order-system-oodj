 ...
 * @author CCK
 */
public class ManageOrders extends javax.swing.JFrame implements Validable {
...
//        
        ...
        for (Orders order : orders) {
            model.addRow(new Object[]{order.getID(), order.getTotalAmount(), order.getCustomer(), order.getCreatedAt(), order.getUpdateAt()});
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Orders Management Section");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Customer", "TotalAmount", "CreatedAt", "updatedAt"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        jLabel7.setText("Add Orders Section");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (price.isEmpty()) {
            //validation
            JOptionPane.showMessageDialog(null, "please fill in the price");
        } else {
